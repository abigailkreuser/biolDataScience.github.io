...
Write code that runs logisticDynamics in parallel, running out the dynamics of the logistic model for 
100 steps, but starting with population sizes between 1 and 1000. 
